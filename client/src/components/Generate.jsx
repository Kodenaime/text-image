...
const Generate = () => {
  return (
    <div className='pb-16 text-center'>
        ...
        <button className='inline-flex items-center gap-2 px-12 py-3 rounded-lg bg-black text-white m-auto hover:scale-1-5 transition-all duration-500'>Generate images
